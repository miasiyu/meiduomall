...
SECRET_KEY = 'l64s%9^6==!lff)r2cwum=a#22d8qo6b3pg^kz)n2y1qz2^-z+'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'static'), #静态文件夹的位置
]
...
LOGGING = {
    ...
    'loggers': {  # 日志器
        'django': {  # 定义了一个名为django的日志器
            ...
            'level': 'INFO',  # 日志器接收的最低日志级别 5种级别,DEBUG < INFO <WARNING <ERROR <CRETICAL
        },
    }
}
